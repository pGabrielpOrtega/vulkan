...
public class decProductoAlmacen implements Serializable{
    ...
    public int getCanitdad_actual() {
        return canitdad_actual;
    }

    public void setCanitdad_actual(int canitdad_actual) {
        this.canitdad_actual = canitdad_actual;
    }
