...
public class jFramePuesto extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel6.add(txt_nombre_puestos, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 60, 240, -1));
        ...
        jPanel6.add(txt_id_area, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 20, 70, -1));
    ...
    private void btn_buscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_buscarActionPerformed
        String input = JOptionPane.showInputDialog("Ingrese el nombre del puesto a buscar");
        limpiar();
        Boolean find = false;
        for (int i = 0; i < tbl_registros.getRowCount(); i++) {//For each row
            if (tbl_registros.getModel().getValueAt(i, 1).equals(input)) {//Search the model
                ...
                txt_nombre_puestos.setText(tbl_registros.getModel().getValueAt(i, 1).toString());
