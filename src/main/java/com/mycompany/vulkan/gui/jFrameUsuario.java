...
public class jFrameUsuario extends javax.swing.JFrame {
    ...
    private void registrar() {
        ...
        } else if (!txt_contrasenia.getText().equals(txt_contraseniaR.getText())){
    ...
    private void initComponents() {
        ...
        txt_contraseniaR = new javax.swing.JPasswordField();
        ...
        jPanel6.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 130, -1, -1));
        ...
        jPanel6.add(txt_usuario, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 90, 170, -1));
        ...
        jPanel6.add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 160, -1, -1));
        jPanel6.add(txt_contraseniaR, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 160, 170, -1));
        jPanel6.add(txt_contrasenia, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 130, 170, -1));
    ...
    private void tbl_registrosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbl_registrosMouseClicked
        ...
        if (model.getValueAt(row, 4).equals("Activado")) {
    ...
    private void btn_buscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_buscarActionPerformed
        String input = JOptionPane.showInputDialog("Ingrese el nombre de usuario a buscar");
        limpiar();
        Boolean find = false;
        for (int i = 0; i < tbl_registros.getRowCount(); i++) {//For each row
            if (tbl_registros.getModel().getValueAt(i, 1).equals(input)) {//Search the model
                ...
                txt_usuario.setText(tbl_registros.getModel().getValueAt(i, 1).toString());
                MD5 md5 = new MD5();
                String pass = md5.deecnode(tbl_registros.getModel().getValueAt(i, 2).toString());
                txt_contrasenia.setText(pass);
    ...
    private javax.swing.JPasswordField txt_contraseniaR;
