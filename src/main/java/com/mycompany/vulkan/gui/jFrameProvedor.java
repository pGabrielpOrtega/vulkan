...
public class jFrameProvedor extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel6.add(btn_buscar, new org.netbeans.lib.awtextra.AbsoluteConstraints(630, 110, -1, -1));
    ...
    private void btn_buscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_buscarActionPerformed
        String input = JOptionPane.showInputDialog("Ingrese el ID de el proveedor a buscar");
        System.out.println(input);
        try {
            parseInt(input);
            decProveedores proveedorBuscar = provedorDao.findclientes(parseInt(input));
            if (proveedorBuscar == null) {
                JOptionPane.showMessageDialog(this, "Proveedor no encontrado");
            } else if (proveedorBuscar.getDesactivado() == 1) {
                JOptionPane.showMessageDialog(this, "Proveedor está actualmente desactivado");
            } else {
                String idn = String.valueOf(proveedorBuscar.getId_proveedores());
                txt_id_area.setText(idn);
                txt_nombre.setText(proveedorBuscar.getNombre());
