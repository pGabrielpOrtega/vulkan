...
public class jFrameEmpleado extends javax.swing.JFrame {
    ...
    private void llenadoTabla() {
        ...
        modelo.addColumn("Número del documento");
    ...
    private void initComponents() {
        ...
        jPanel7.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 60, -1, -1));
        ...
        jPanel7.add(txt_telefono, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 60, 150, -1));

        jLabel8.setText("Puesto");
        jPanel7.add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 100, -1, -1));
        ...
        jPanel7.add(cbb_puesto, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 100, 150, -1));
        ...
        jPanel7.add(cbb_documento, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 140, 150, -1));

        jLabel9.setText("Tipo de documento");
        jPanel7.add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 140, -1, -1));
        ...
        jPanel7.add(txt_id_documento, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 180, 150, -1));

        jLabel12.setText("Número del documento");
        jPanel7.add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 180, -1, -1));
        ...
        jPanel7.add(btn_buscar, new org.netbeans.lib.awtextra.AbsoluteConstraints(750, 120, -1, -1));
    ...
    private void btn_agregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_agregarActionPerformed
        ...
        if (valString.tresKey(txt_nombre.getText()) == false) {
            ...
            empleado.setNombre_documento(cbb_documento.getSelectedItem().toString());
            List<decTipoDeDocumento> tipoDocumento = tipoDocumentoDao.findclientesEntities();
            for (decTipoDeDocumento unTipo : tipoDocumento) {
                if (unTipo.getDesactivado() == 0) {
                    if (unTipo.getNombre().equals(cbb_documento.getSelectedItem().toString())) {
                        empleado.setId_tipo_documento(unTipo.getId());
                    }
                }
            }
    ...
    private void btn_modificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_modificarActionPerformed
        ...
        if (valString.tresKey(txt_nombre.getText()) == false) {
            ...
            empleado.setId_empleado(parseInt(txt_id_area.getText()));
            empleado.setNombre(txt_nombre.getText());
            empleado.setApellido(txt_apellido.getText());
            empleado.setTelefono(Integer.parseInt(txt_telefono.getText()));
            empleado.setEmail(txt_email.getText());
    ...
    private void tbl_registrosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbl_registrosMouseClicked
        ...
        if (tbl_registros.getValueAt(row, 9).toString().equals("Activado")) {
    ...
    private void btn_buscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_buscarActionPerformed
        String input = JOptionPane.showInputDialog("Ingrese el nombre completo del empleado a buscar");
        String nombre = "";
        String apellido = "";
        ...
        for (int i = 0; i < tbl_registros.getRowCount(); i++) {//For each row
            if (tbl_registros.getModel().getValueAt(i, 1).equals(nombre)
                ...
                txt_direccion.setText(tbl_registros.getModel().getValueAt(i, 4).toString());
                txt_email.setText(tbl_registros.getModel().getValueAt(i, 5).toString());
                txt_telefono.setText(tbl_registros.getModel().getValueAt(i, 3).toString());

                cbb_puesto.setSelectedItem(tbl_registros.getModel().getValueAt(i, 6).toString());
                cbb_documento.setSelectedItem(tbl_registros.getModel().getValueAt(i, 7).toString());

                txt_id_documento.setText(tbl_registros.getModel().getValueAt(i, 8).toString());

                if (tbl_registros.getModel().getValueAt(i, 9).equals("Activado")) {
                    btn_desactivar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/Desactivar1.png")));
                    this.estado = true;
                } else {
                    btn_desactivar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/Activar.png")));
