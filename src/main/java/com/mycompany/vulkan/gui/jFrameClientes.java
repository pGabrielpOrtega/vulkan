...
public class jFrameClientes extends javax.swing.JFrame {
    ...
    private void registrar() {
        ...
        } else if ((String.valueOf(cbb_documento.getSelectedItem().toString()).equalsIgnoreCase("DNI")
                && ValidacionDNI(txt_id_documento.getText()) == false)
                || (String.valueOf(cbb_documento.getSelectedItem()).equalsIgnoreCase("identidad")
                && ValidacionDNI(txt_id_documento.getText()) == false)
                || (String.valueOf(cbb_documento.getSelectedItem().toString()).equalsIgnoreCase("RTN")
    ...
    private void initComponents() {
        ...
        jLabel11.setText("ID del documento");
        ...
        jPanel6.add(cbb_documento, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 60, 120, -1));
    ...
    private void tbl_registrosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbl_registrosMouseClicked
        ...
        cbb_documento.setSelectedItem(model.getValueAt(row, 6).toString());
        txt_direccion.setText(model.getValueAt(row, 5).toString());
        txt_id_documento.setText(model.getValueAt(row, 7).toString());
        if (tbl_registros.getValueAt(row, 8).toString().equals("Activado")) {
    ...
    private void btn_buscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_buscarActionPerformed
        String input = JOptionPane.showInputDialog("Ingrese el nombre completo del cliente a buscar");
        String nombre = "";
        String apellido = "";
        ...
        for (int i = 0; i < tbl_registros.getRowCount(); i++) {//For each row
            if (tbl_registros.getModel().getValueAt(i, 1).equals(nombre)
                ...
                txt_direccion.setText(tbl_registros.getModel().getValueAt(i, 5).toString());
                ...
                cbb_documento.setSelectedItem(tbl_registros.getModel().getValueAt(i, 6).toString());

                txt_id_documento.setText(tbl_registros.getModel().getValueAt(i, 7).toString());
