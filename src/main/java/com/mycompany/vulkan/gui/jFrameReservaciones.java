...
public class jFrameReservaciones extends javax.swing.JFrame {
    ...
    private void limpiar() {
        ...
        cbb_anio.setEnabled(false);
        cbb_mesas.setEnabled(false);
    ...
    private void initComponents() {
        ...
        lbl_mensaje.setText("Buscar");
        jPanel6.add(lbl_mensaje, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 50, -1, -1));

        jLabel6.setText("Número de mesa");
        jPanel6.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 110, -1, -1));

        jLabel7.setText("Fecha");
        jPanel6.add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 30, -1, -1));
        ...
        jPanel6.add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 180, -1, -1));
        ...
        jPanel6.add(cbb_mesas, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 110, 150, -1));
        ...
        jPanel6.add(cbb_dia, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 70, 50, -1));
        ...
        jPanel6.add(cbb_mes, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 70, 50, -1));
        ...
        jPanel6.add(cbb_anio, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 70, 70, -1));
        ...
        jPanel6.add(cbb_horaf, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 180, 50, -1));

        cbb_minutof.setEnabled(false);
        jPanel6.add(cbb_minutof, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 180, 50, -1));
        ...
        jPanel6.add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 50, -1, -1));

        jLabel12.setForeground(new java.awt.Color(153, 153, 153));
        jLabel12.setText("Año");
        jPanel6.add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 50, -1, -1));

        jLabel13.setForeground(new java.awt.Color(153, 153, 153));
        jLabel13.setText("Día");
        jPanel6.add(jLabel13, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 50, -1, -1));

        jLabel14.setForeground(new java.awt.Color(153, 153, 153));
        jLabel14.setText("Hora");
        jPanel6.add(jLabel14, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 160, -1, -1));

        jLabel15.setForeground(new java.awt.Color(153, 153, 153));
        jLabel15.setText("Minutos");
        jPanel6.add(jLabel15, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 160, -1, -1));
        ...
        jPanel6.add(btn_buscar, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 110, -1, -1));
        ...
        jPanel6.add(btn_limpiar, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 170, -1, -1));

        txt_nombre.setBackground(new java.awt.Color(255, 255, 255));
        jPanel6.add(txt_nombre, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 70, 150, -1));
        ...
        jPanel6.add(btn_buscar_cliente, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 70, -1, -1));

        txt_descripcion_mesa.setEditable(false);
        txt_descripcion_mesa.setBackground(new java.awt.Color(204, 204, 204));
        jPanel6.add(txt_descripcion_mesa, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 110, 230, 30));

        jPanel5.add(jPanel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 20, 620, 230));
                ...
                if (!cbb_mes.getSelectedItem().equals("-")) {
                    ...
                    if (cbb_mes.getSelectedItem().equals(fecha.mes())) {
                        ...
                        for (int i = dia; i <= 31; i++) {
                            if (i <= 9) {
                                cbb_dia.addItem("0" + String.valueOf(i));
                            } else {
        ...
        for (decClientes unCliente : clientes) {
            ...
            if (clientN.equals(nombre) && clientA.equals(apellido)) {
                if (unCliente.getDesactivado() != 1) {
                    ...
                    cbb_anio.setEnabled(true);
                    cbb_mesas.setEnabled(true);
    ...
    private void btn_buscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_buscarActionPerformed
        String input = JOptionPane.showInputDialog("Ingrese el nombre del cliente con reservación a buscar");
        String nombre = "";
        String apellido = "";
        String[] inp = input.split(" ");
        limpiar();
        ...
        for (int i = 0; i < tbl_registros.getRowCount(); i++) {//For each row
            if (tbl_registros.getModel().getValueAt(i, 1).equals(input)
                    && tbl_registros.getModel().getValueAt(i, 5).equals("Activado")) {//Search the model
                ...
                cbb_mesas.setEnabled(true);
                cbb_mesas.setSelectedItem(tbl_registros.getModel().getValueAt(i, 2).toString());

                String[] fechaCompleta = tbl_registros.getModel().getValueAt(i, 3).toString().split(" ");
                String[] fechaCalendario = fechaCompleta[0].split("-");
                String[] fechaHoraCompleta = fechaCompleta[1].split(":");

                String[] fechaCompletaEnd = tbl_registros.getModel().getValueAt(i, 4).toString().split(" ");
                String[] fechaHoraCompletaEnd = fechaCompletaEnd[1].split(":");

                cbb_anio.setEnabled(true);
                cbb_anio.setSelectedItem(fechaCalendario[0]);
                cbb_mes.setSelectedItem(fechaCalendario[1]);
                cbb_dia.setSelectedItem(fechaCalendario[2]);

                cbb_horai.setSelectedItem(fechaHoraCompleta[0]);
                cbb_minutoi.setSelectedItem(fechaHoraCompleta[1]);

                cbb_horaf.setSelectedItem(fechaHoraCompletaEnd[0]);
                cbb_minutof.setSelectedItem(fechaHoraCompletaEnd[1]);

                if (tbl_registros.getModel().getValueAt(i, 5).equals("Activado")) {
    ...
    private void tbl_registrosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbl_registrosMouseClicked
        ...
        txt_id.setText(tbl_registros.getModel().getValueAt(row, 0).toString());
        txt_nombre.setText(tbl_registros.getModel().getValueAt(row, 1).toString());
        cbb_mesas.setEnabled(true);
        cbb_mesas.setSelectedItem(tbl_registros.getModel().getValueAt(row, 2).toString());

        String[] fechaCompleta = tbl_registros.getModel().getValueAt(row, 3).toString().split(" ");
        String[] fechaCalendario = fechaCompleta[0].split("-");
        String[] fechaHoraCompleta = fechaCompleta[1].split(":");

        String[] fechaCompletaEnd = tbl_registros.getModel().getValueAt(row, 4).toString().split(" ");
        String[] fechaHoraCompletaEnd = fechaCompletaEnd[1].split(":");
        ...
        if (tbl_registros.getModel().getValueAt(row, 5).equals("Activado")) {
            btn_desactivar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/Desactivar1.png")));
            this.estado = true;
        } else {
            btn_desactivar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/Activar.png")));
