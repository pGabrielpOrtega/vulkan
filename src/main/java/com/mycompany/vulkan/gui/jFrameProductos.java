...
public class jFrameProductos extends javax.swing.JFrame {
    ...
    private void btn_modificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_modificarActionPerformed
        ...
        if (valNumero.unoKey(txt_precio.getText()) == false) {
            ...
            productos.setid_producto(parseInt(txt_id2.getText()));
            productos.setNombre(txt_nombre.getText());
            productos.setPrecio(Double.parseDouble(txt_precio.getText()));
            productos.setDescripcion(txt_descripcion.getText());
            try {
    ...
    private void btn_buscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_buscarActionPerformed
        String input = JOptionPane.showInputDialog("Ingrese el nombre del producto a buscar");
        limpiar();
        Boolean find = false;
        for (int i = 0; i < tbl_registros.getRowCount(); i++) {//For each row
            if (tbl_registros.getModel().getValueAt(i, 1).equals(input)) {//Search the model
                txt_id2.setText(tbl_registros.getModel().getValueAt(i, 0).toString());
                ...
                txt_precio.setText(tbl_registros.getModel().getValueAt(i, 3).toString());
    ...
    private void Activar_Desactivar() {
        ...
        String a = txt_id2.getText().toString();
